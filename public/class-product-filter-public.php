 ...
 * @subpackage Product_Filter/public
 */
...
class Product_Filter_Public {
	...
	public function __construct( $plugin_name, $version ) {
		...
		add_shortcode( "filter_product", [$this, "filter_product_callback"] );
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/product-filter-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/product-filter-public.js', array( 'jquery', 'owl-carousel' ), $this->version, true );

	}

	function filter_product_callback(){
		ob_start();
		require_once plugin_dir_path( __FILE__ )."partials/product-filter-public-display.php";
		return ob_get_clean();
	}
